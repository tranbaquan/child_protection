...
public class ParentsApi implements Crud<Parent> {
    ...
    @PutMapping("link")
    public boolean linkToChild(@RequestParam String parentId, @RequestParam String childPhone) {
        return service.linkToChild(parentId, childPhone);
    }
    ...
    @GetMapping("safe")
    public List<SafeZone> retrieveAllSafeZone(@RequestParam String childId) {
